...
This module isn't intended as a Module Author example: it has been designed to act as a load generator for use in [Pepr Load Testing](https://github.com/defenseunicorns/pepr/blob/main/hack/load.cli.ts).
